...
public class UserBatchConfig {
    ...
    public FlatFileItemReader<UserInput> reader() {
        ...
        itemReader.setResource(new FileSystemResource("src/main/resources/MOCK_DATA_1K_Rows.csv"));
    ...
    private LineMapper<UserInput> lineMapper() {
        ...
        lineTokenizer.setNames("uuid", "name", "surname", "age"
                , "username", "email", "gender",
                "job", "country", "city", "street", "detailedAddress", "time",
                "phone", "lat", "lon", "language"
        );
